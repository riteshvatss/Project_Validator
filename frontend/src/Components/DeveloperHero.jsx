...
function DeveloperHero() {
  ...
  return (
    <div className="relative pt-20 sm:pt-28 md:pt-36 overflow-hidden">
      <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-purple-600/20 blur-3xl rounded-full animate-floatSlow" />
      <div className="absolute top-40 -right-40 w-[500px] h-[500px] bg-blue-600/20 blur-3xl rounded-full animate-floatSlow delay-200" />
      ...
      ">
        <div className="pt-10 sm:pt-16 md:pt-28 px-2 sm:px-4 md:pl-8">
          ...
          ">
            ...
            <span className="
              inline-block bg-gradient-to-r from-purple-400 to-blue-500
          ...
          <p className="
            ...
            text-gray-300 pt-4 max-w-xl
            animate-fadeIn delay-200
          ">
            Ship projects, earn trust, and prove your skills to the world.
          </p>
          <div className="pt-8 sm:pt-10 animate-fadeIn delay-400">
            <button
              onClick={() => navigate("/developerBulkTask")}
              className="
